        ...
        <>
            <div className="flex flex-col gap-6 p-4 md:p-6 bg-gray-50 min-h-full">
                <div className="space-y-1 text-center">
                    {/* @ts-ignore */}
                    <dotlottie-wc src="https://lottie.host/622d2197-f9b0-4d02-9301-622e4b6c8d07/QUGWvgvzay.lottie" style={{width: '500px', height: '500px', margin: '0 auto'}} speed="1" autoplay loop></dotlottie-wc>
